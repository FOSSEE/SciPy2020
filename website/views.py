        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
               ...
               # data.attachment = request.FILES
                ...
                sender_name = "SciPy India 2020"
                sender_email = TO_EMAIL
                subject = "SciPy India 2020 – Paper Submission Acknowledgement "
                to = (social_user.email, TO_EMAIL)
                message = """
                Dear {0}, <br><br>
                Thank you for showing interest & submitting a paper proposal at SciPy India 2020 
                ...
                <br>Thank You. <br><br>Regards,<br>SciPy India 2020,<br>FOSSEE - IIT Bombay.
                """.format(
                    social_user.first_name,
                    request.POST.get('title', None),
                    'https://scipy.in/2020/view-abstracts/',)
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                sender_name = "SciPy India 2020"
                sender_email = TO_EMAIL
                subject = "SciPy India 2020 – Workshop Proposal Submission Acknowledgment"
                to = (social_user.email, TO_EMAIL)
                message = """
                Dear {0}, <br><br>
                Thank you for showing interest & submitting a workshop proposal at SciPy India 2020 conference for the workshop titled <b>“{1}”</b>. Reviewal of the proposals will start once the CFP closes.
        ...
        if user.is_staff:
            ...
            try:
                ...
                if proposal.user == user:
                    try:
                        url = '/2020'+str(proposal.attachment.url)
                        context['url'] = url
                    except:
                        pass
        ...
        if user.is_staff:
            try:
                ...
                if request.method == 'POST':
                    ...
                    if proposal.proposal_type == 'ABSTRACT':
                        subject = "SciPy India 2020 - Comment on Your talk Proposal"
                        message = """
                            Dear {0}, <br><br>
                            ...
                            Thank You ! <br><br>Regards,<br>SciPy India 2020,<br>FOSSEE - IIT Bombay.
                            """.format(
                            proposal.user.first_name,
                            proposal.title,
                            'https://scipy.in/2020/abstract-details/' +
                            str(proposal.id),
                        )
                    elif proposal.proposal_type == 'WORKSHOP':
                        subject = "SciPy India 2020 - Comment on Your Workshop Proposal"
                        message = """
                            Dear {0}, <br><br>
                            ...
                            proposal.user.first_name,
                            proposal.title,
                            'http://scipy.in/2020/abstract-details/' +
                            str(proposal.id),
                        )
                    #email = EmailMultiAlternatives(
                    #    subject, '',
    ...
    if user.is_authenticated:
        if user.is_staff:
            ...
            if 'accept' in request.POST:
                ...
                to = (proposal.user.email, TO_EMAIL)
                if proposal.proposal_type == 'ABSTRACT':
                    subject = "SciPy India 2020 - Talk Proposal Accepted"
                    ...
                    subject = "SciPy India 2020 - Workshop Proposal Accepted"
                    message = """Dear """+proposal.user.first_name+""",
                ...
                to = (proposal.user.email, TO_EMAIL, )
                if proposal.proposal_type == 'ABSTRACT':
                    subject = "SciPy India 2020 - Talk Proposal Rejected"
                    message = """Dear """+proposal.user.first_name+""",
                   ...
                   # Having said that, we do encourage you to attend the conference.  We hope you do change your ways and be honest in the future.
                    ...
                    subject = "SciPy India 2020 - Workshop Proposal Rejected"
                    message = """Dear """+proposal.user.first_name+""",
                ...
                sender_email = TO_EMAIL
                if proposal.proposal_type == 'ABSTRACT':
                    subject = "SciPy India 2020 - Talk Proposal Resumbmission"
                    message = """
                    Dear {0}, <br><br>
                    ...
                    subject = "SciPy India 2020 - Workshop Proposal Resubmission"
                    message = """
                    Thank you for showing interest & submitting a workshop proposal at SciPy India 2020 conference for the workshop titled <b>"{1}"</b>. You are requested to submit this talk proposal once        again.<br>
            ...
            if 'delete' in request.POST:
                ...
                for proposal_id in delete_proposal:
                    ...
                    if proposal.proposal_type == 'ABSTRACT':
                        ...
                        message = """Dear {0}, \n
Thank you for your submission to SciPy India 2020!  We are pleased to inform you that your talk has been accepted!  We will be finalizing the rough schedule of the talks in a couple of days and will update you regarding the duration of your talk along with additional details.  It will be for either 15 minutes or 20 minutes at most in total including Q&A.  

Please confirm your participation via return email on or before 08 November(Friday).  The tentative schedule will be put up in a few days.  We look forward to hearing your talk and seeing you at SciPy India 2020.

Thank You ! \n\nRegards,\nSciPy India 2020 Program Chairs,\nFOSSEE - IIT Bombay.
                        """.format(
                            proposal.user.first_name,
                        )
                    elif proposal.proposal_type == 'WORKSHOP':
                        subject = "SciPy India 2020 - Workshop Proposal Accepted"
                        message = """Dear {0}, \n
Thank you for your submission at SciPy India 2020!  We are pleased to accept your workshop. Each workshop is allotted a time slot of 2 hours. Please plan for 1 hour and 55 minutes in order to give the participants a 10 minute break between workshops for tea.

The tentative schedule will be put up on the website in a few days. Please confirm your participation via an email to scipy@fossee.in on or before 08 November, 2020(Friday). We shall be waiving the registration fee for the speakers. In case you have already registered we shall reimburse the registration charges at the conference venue.
...
Thank You! \n\nRegards,\nSciPy India 2020 Program Chairs,\nFOSSEE - IIT Bombay."""
                ...
                for proposal_id in delete_proposal:
                    ...
                    to = (proposal.user.email, TO_EMAIL)
                    if proposal.proposal_type == 'ABSTRACT':
                        subject = "SciPy India 2020 - Talk Proposal Acceptance"
                        message = """Dear {0}, \n
...
Thank You ! \n\nRegards,\nSciPy India 2020,\nFOSSEE - IIT Bombay.
                        ...
                        subject = "SciPy India 2020 - Workshop Proposal Resubmission"
                        message = """Dear {0}, \n
Thank you for showing interest & submitting a workshop proposal at SciPy India 2020 conference for the workshop titled <b>"{1}"</b>. You are requested to submit this talk proposal once again.\n
...
def user_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if request.user.is_authenticated:
                return redirect('/2020/view_profile/')
            return render(
        ...
        if request.user.is_authenticated and is_email_checked(request.user):
            return redirect('/2020/view-abstracts/')
